...
namespace FBM.Data
{
    public static class DbContextExtensions
    {
        ...
        public static NotifierEntity GetNotifierEntity<TEntity>(this DbContext dbContext, IQueryable iQueryable) where TEntity : BaseEntity
        {
        ...
        public static ObjectQuery GetObjectQuery<TEntity>(this DbContext dbContext, IQueryable query) where TEntity : BaseEntity
        {
